...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 1000, intensity: 2, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#buttons05', { style: 'fade-up', speed: 1000, intensity: 2, delay: 250, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 750, intensity: 2, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 1000, intensity: 2, delay: 250, replay: false });
